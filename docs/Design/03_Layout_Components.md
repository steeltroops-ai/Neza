        ...
        className={`
          ...
          ${
            error
              ...
              : 'focus:border-primary-500 focus:ring-primary-500 border-neutral-300'
          }
        `}
      />
      {error && (
        <p className="text-error-600 flex items-center text-sm">
          <ExclamationIcon className="mr-1 h-4 w-4" />
          {error}
        </p>
      )}
    </div>
...
<Card variant="elevated" padding="md" className="hover:scale-105">
  <div className="flex items-start space-x-4">
    <img src="/service-image.jpg" alt="Service" className="h-16 w-16 rounded-lg object-cover" />
    <div className="flex-1">
      <h3 className="text-lg font-semibold text-neutral-800">Home Cleaning</h3>
      <p className="mt-1 text-sm text-neutral-600">Professional cleaning service</p>
      <div className="mt-4 flex items-center justify-between">
        <span className="text-primary-600 text-lg font-bold">$50/hour</span>
  ...
  return (
    <div className={`rounded-lg p-4 ${currentStyle.container}`}>
      <div className="flex items-start">
        <div className={`flex-shrink-0 ${currentStyle.icon}`}>{/* Icon based on type */}</div>
        <div className="ml-3 flex-1">
          {title && <h3 className={`text-sm font-medium ${currentStyle.title}`}>{title}</h3>}
          <p className={`text-sm ${title ? 'mt-1' : ''} ${currentStyle.message}`}>{message}</p>
        </div>
        {dismissible && (
          <button
            onClick={onDismiss}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden items-center space-x-8 md:flex">
            <Link href="/services" className="hover:text-primary-600 text-neutral-600">
              Browse Services
            </Link>
            <Link href="/become-provider" className="hover:text-primary-600 text-neutral-600">
              Become a Provider
            </Link>
            <Link href="/how-it-works" className="hover:text-primary-600 text-neutral-600">
              How It Works
            </Link>
          </nav>
    ...
    <footer className="bg-neutral-900 text-white">
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 text-neutral-300">
              Your trusted platform for local services. Connect with verified providers and book
              services instantly.
            </p>
        ...
        <div className="mt-8 flex flex-col items-center justify-between border-t border-neutral-800 pt-8 md:flex-row">
          <p className="text-sm text-neutral-400">© 2024 Neza. All rights reserved.</p>
...
<Card className="w-full">
  ...
  <div className="block sm:hidden">
    <img src="/service.jpg" className="h-48 w-full rounded-t-lg object-cover" />
    <div className="p-4">
      <h3 className="text-lg font-semibold">Service Title</h3>
      <p className="mt-1 text-sm text-neutral-600">Description</p>
      <div className="mt-4 flex items-center justify-between">
        <span className="text-primary-600 text-xl font-bold">$50/hr</span>
  ...
  {/* Desktop Layout */}
  <div className="hidden items-center space-x-4 p-6 sm:flex">
    <img src="/service.jpg" className="h-20 w-20 rounded-lg object-cover" />
    <div className="flex-1">
      <h3 className="text-xl font-semibold">Service Title</h3>
      <p className="mt-1 text-neutral-600">Description</p>
    </div>
    <div className="text-right">
      <span className="text-primary-600 text-2xl font-bold">$50/hr</span>
      <Button variant="primary" size="md" className="mt-2 w-32">
        Book Now
      </Button>
    </div>
  </div>
